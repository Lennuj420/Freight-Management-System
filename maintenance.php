    ...
    <div class="fixed-action-btn">
      ...
      <ul>
        <li>
          ...
          <a href="new-job-order.php" class="btn-floating blue darken-2 modal-trigger">
              ...
              <div class="col s12 ">
                <ul class="collection with-header">
                  ...
                  <li class="collection-item">
                    <div>Bulb 24v Single Small<a href="#!" class="secondary-content"><i
                          class="material-icons">send</i></a></div>
                  </li>
                  <li class="collection-item">
                    <div>Bulb 24v Double Big<a href="#!" class="secondary-content"><i
                          class="material-icons">send</i></a></div>
                  </li>
                  <li class="collection-item">
                    <div>Battery Terminal<a href="#!" class="secondary-content"><i class="material-icons">send</i></a>
                    </div>
                  </li>
                </ul>
              </div>
